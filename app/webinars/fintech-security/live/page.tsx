    ...
    <div className="container px-4 py-12 md:px-6 max-w-7xl mx-auto">
      <div className="mb-6">
        ...
        <div className="flex items-center justify-between">
          <h1 className="text-3xl font-bold tracking-tight">Cybersecurity in FinTech</h1>
          <Badge className="bg-red-500">LIVE</Badge>
        </div>
        <p className="text-muted-foreground mt-2">Live Webinar with Emily Carter</p>
      </div>
            ...
            <CardContent className="p-6">
              ...
              <div className="prose max-w-none">
                <p className="mb-4">
                  ...
                  technology sector. Emily Carter will cover the latest threats facing FinTech companies and practical
                  strategies to mitigate risks.
                </p>

                <h3 className="text-lg font-bold mb-2">Key Topics:</h3>
                <ul className="list-disc pl-5 space-y-1 mb-4">
                  <li>Current cybersecurity landscape in FinTech</li>
                  <li>Common attack vectors and vulnerabilities</li>
                  <li>Regulatory compliance and security standards</li>
                  <li>Best practices for securing financial applications</li>
                ...
                <div className="bg-muted/50 p-4 rounded-md mt-6">
                  ...
                  <p>
                    Presentation slides and additional resources will be shared with participants after the webinar.
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="p-6">
              ...
              <div className="flex items-center gap-4 mb-4">
                <Avatar className="h-16 w-16">
                  <AvatarImage src="/placeholder.svg?height=64&width=64" alt="Emily Carter" />
                  <AvatarFallback>EC</AvatarFallback>
                </Avatar>
                <div>
                  <h4 className="font-bold">Emily Carter</h4>
                  <p className="text-sm text-muted-foreground">Chief Security Officer at FinSecure</p>
                </div>
              </div>
              <p className="text-sm mb-6">
                Emily Carter is a cybersecurity expert with over 15 years of experience in the financial technology
                sector. She specializes in threat detection, secure architecture design, and regulatory compliance for
                financial institutions. Emily is a frequent speaker at industry conferences and has published numerous
                articles on cybersecurity best practices.
              </p>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>Cybersecurity Challenges and Solutions in FinTech</div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="font-medium min-w-[100px]">Duration:</div>
                  <div>90 minutes (60 min presentation + 30 min Q&A)</div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="font-medium min-w-[100px]">Materials:</div>
                  <div>Slides and resources will be available for download after the session</div>
                </div>
              </div>
